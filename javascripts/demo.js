...
if (biicore.bgMusic) {
	...
	<div class="bii-player">
		<div onclick="playPause();" class="bii-player-secondary"><div class="bii-player-secondary-content">Click vào để tắt nhạc!</div></div>
		<div onclick="playPause();" class="playerIcon">
			<span style="display:none;"  id="playerVolumeOff">
...
if (!biicore.isPremium) {
	...
	<div class="bii-footer" style="background-color: #000;border-top:2px solid #df4759;padding: 15px 0;color:#fff;text-align:center;letter-spacing: 1px;"><div class="container">☆( © 2022 Phạm Tùng | Chúc hai bạn trăm năm hạnh phúc )☆</div></div>
	`);
}