(function($) {
   ...
   if ($("#wish-form").length) {
        $("#wish-form").validate({
            ...
            messages: {
                name: {
                    required: 'Vui l챵ng nh梳춑 t챗n c沼쬪 b梳죒.',
                    minlength: 'T챗n ph梳즜 l沼썀 h퉤n 5 k첵 t沼�.',
                },
                content: {
                    required: 'Vui l챵ng nh梳춑 l沼쓎 ch첬c.',
                    minlength: 'L沼쓎 ch첬c ph梳즜 l沼썀 h퉤n 10 k첵 t沼�.',
                },
                email: {
                    email: '휂沼땇 ch沼� email kh척ng h沼즤 l沼�.'
                }
            },
