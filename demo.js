...
if (biicore.bgMusic) {
	...
	<div class="bii-player">
		<div onclick="playPause();" class="bii-player-secondary"><div class="bii-player-secondary-content">Click vào để phát nhạc!</div></div>
...
if (!biicore.isPremium) {
	...
	<div class="bii-footer" style="background-color: #000;border-top:2px solid #df4759;padding: 15px 0;color:#fff;text-align:center;letter-spacing: 1px;"><div class="container">â˜†( Â© ${currentYear} <a style="color:#fff;" href="https://biihappy.com/wedding" target="_blank">Biihappy.com</a> | <a style="color:#fff;" href="https://biihappy.com/wedding" target="_blank">Ná»n táº£ng táº¡o website Ä‘Ã¡m cÆ°á»›i miá»…n phÃ­ tá»« Biihappy</a> )â˜†</div></div>
	`);
}